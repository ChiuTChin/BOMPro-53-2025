...
public:	//cell
	...
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		UExcelCell* CellAtFirstRowColumnName(FString columnName, int32 row = 2)const;
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		bool ToBoolWithFirstRowColumnName(FString columnName, int32 row = 2)const;
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		int32 ToIntWithFirstRowColumnName(FString columnName, int32 row = 2)const;
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		float ToFloatWithFirstRowColumnName(FString columnName, int32 row = 2)const;
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FString ToStringWithFirstRowColumnName(FString columnName, int32 row = 2)const;
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FDateTime ToDateTimeWithFirstRowColumnName(FString columnName, int32 row = 2)const;
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FVector ToVectorWithFirstRowColumnName(FString columnName, int32 row = 2)const { return CellAtFirstRowColumnName(columnName,row)->ToVector(); }
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FRotator ToRotatorWithFirstRowColumnName(FString columnName, int32 row = 2)const { return CellAtFirstRowColumnName(columnName,row)->ToRotator(); }
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FTransform ToTransformWithFirstRowColumnName(FString columnName, int32 row = 2)const { return CellAtFirstRowColumnName(columnName,row)->ToTransform(); }
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FColor ToColorWithFirstRowColumnName(FString columnName, int32 row = 2)const { return CellAtFirstRowColumnName(columnName,row)->ToColor(); }
	UFUNCTION(BlueprintPure, Category = "DirectExcel|Worksheet")
		FMatrix ToMatrixWithFirstRowColumnName(FString columnName, int32 row = 2)const { return CellAtFirstRowColumnName(columnName,row)->ToMatrix(); }
